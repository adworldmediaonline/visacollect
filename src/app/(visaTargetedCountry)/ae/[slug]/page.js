...
import { visaPromotedInUAE } from '@/app/(visaTargetedCountryContent)/content/visaTargetedCountry';

export async function generateMetadata({ params }) {
  try {
    const slug = params.slug;
    const promotedVisa = visaPromotedInUAE?.find(
...
>>>>>>> 7ef5c27678b82d062d1f3b994dfecad072ab6c1c
