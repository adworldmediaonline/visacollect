...
function Page({ params }) {
  ...
  if (getQuery.error) {
    return router.push('/indonesia/payment');
  }
    ...
    return (
      <div>
        <div className="container  md:py-8 py-20 md;px-0 px-3 ">
          ...
          <div>
            <Formik
              initialValues={indonesiaVisaApplicationData}
                ...
                <Form>
                  ...
                  <div className="pt-10 main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={
                          new Date(values.travelDetails.intendedDateOfEntry)
                        }
                        setFieldValue={setFieldValue}
                        minDate={new Date()}
                      />
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={
                          new Date(values.travelDetails.intendedDateOfExit)
                        }
                        setFieldValue={setFieldValue}
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="mark-section group">
                      <BsQuestionCircleFill className=" side-icon" size={20} />
                      <div className="tooltip-content">
                        Please indicate the address of your accommodation or
                        host. If you are staying on a cruise ship, please
                        provide the name.
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col gap-2 py-4">
                    <h2>
                      Are you traveling with minors (under 18 years old)? *
                    </h2>
