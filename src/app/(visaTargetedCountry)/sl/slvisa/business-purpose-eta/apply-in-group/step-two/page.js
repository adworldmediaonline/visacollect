...
const Page = () => {
  ...
  if (getQuery.error) {
    return router.push('/sl/slvisa/business-purpose-eta/apply-in-group');
  }
              ...
              {({ values, isValid, setFieldValue }) => (
                <Form>
                          ...
                          businessGroupsData?.members?.map(member => (
                            <tr key={member._id}>
                              ...
                              <td className={`p-4 flex space-x-5 items-center`}>
                                <Link
                                  href={`/sl/slvisa/business-purpose-eta/apply-in-group/step-two/${member?._id}`}
                                >
                                  <CiEdit size={24} />
                                </Link>
                  ...
                  <div className="flex items-center justify-center my-5">
                    {businessGroupsData?.members?.length > 0 ? (
                      <Link
                        href={`/sl/slvisa/business-purpose-eta/apply-in-group/review/${businessGroupsData?._id}`}
