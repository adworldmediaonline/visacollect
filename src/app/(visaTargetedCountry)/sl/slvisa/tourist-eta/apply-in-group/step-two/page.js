...
const Page = () => {
  ...
  if (getQuery.error) {
    return router.push('/sl/slvisa/tourist-eta/apply-in-group');
  }
              ...
              {({ values, isValid, setFieldValue }) => (
                <Form>
                          ...
                          {touristGroupsData?.members?.length > 0 ? (
                            touristGroupsData?.members?.map(member => (
                              <tr key={member._id}>
                                ...
                                >
                                  <Link
                                    href={`/sl/slvisa/tourist-eta/apply-in-group/step-two/${member?._id}`}
                                  >
                                    <CiEdit size={24} />
                                  </Link>
                  ...
                  <div className="flex items-center justify-center my-5">
                    {touristGroupsData?.members?.length > 0 ? (
                      <Link
                        href={`/sl/slvisa/tourist-eta/apply-in-group/review/${touristGroupsData?._id}`}
