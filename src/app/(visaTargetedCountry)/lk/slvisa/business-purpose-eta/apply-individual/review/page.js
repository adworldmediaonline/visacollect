        ...
        <div className="container">
          ...
          <div className="space-y-2 divide-y-[1px] pt-5">
            ...
            <div className="py-8 text-center">
              <Link
                href={`/lk/slvisa/business-purpose-eta/apply-individual/${businessIndividualData?._id}`}
            ...
            <div className="py-8 text-left">
              <button className="inline-flex items-center gap-3 px-12 py-3 text-white bg-green-700 cursor-pointer formbtn">
                Proceed to Pay
              </button>
