...
const Page = ({ params }) => {
  ...
  const updateMutation = useUpdate(
    ...
    params?.id,
    'form',
    '/lk/slvisa/business-purpose-eta/apply-individual/review',
    getQuery.refetch,
    'businessIndividual'
  );
  ...
  if (getQuery.error) {
    return router.push('/lk/slvisa/business-purpose-eta/apply-individual');
  }

  if (getQuery.isSuccess) {
    const {
      data: { __v, _id, createdAt, updatedAt, ...businessIndividualData },
    } = getQuery.data;
    ...
    return (
      <div>
        ...
        <div className="container md:py-8 py-20 md;px-0 px-3">
          ...
          <div>
            <Formik
              initialValues={businessIndividualData}
                ...
                <Form>
                    ...
                    <div className="order-2 col-span-8">
                      <div className="flex items-center w-full h-full gap-8 p-2 mb-5 overflow-hidden border rounded-md">
                        <div className="bg-gray-200 rounded-lg">
                          <SingleFileUpload
                            id="passportImageBusinessIndividualTourist"
                          ...
                          <label
                            htmlFor="passportImageBusinessIndividualTourist"
                  ...
                  <div className="order-2 col-span-8">
                    <Field
                      required
                      component="select"
                      id="visaValidPeriodBusinessIndividualTourist"
                      name="visaValidPeriodBusinessIndividualTourist"
                      className="new-form-input "
                    >
                      <option value="">Select</option>
                    ...
                    <ErrorMessage name="visaValidPeriodBusinessIndividualTourist">
                      {(errorMsg) => (
                        <div style={{ color: "red" }}>{errorMsg}</div>
                      )}
                    </ErrorMessage>
