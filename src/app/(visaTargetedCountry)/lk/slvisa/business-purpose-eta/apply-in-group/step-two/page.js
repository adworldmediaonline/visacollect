...
const Page = () => {
  ...
  if (getQuery.error) {
    return router.push('/lk/slvisa/business-purpose-eta/apply-in-group');
  }
    ...
    return (
      <div>
        ...
        <div className="container md:py-8 py-20 md;px-0 px-3">
          ...
          <div>
            <Formik
              initialValues={businessGroupSchema.initialValuesMember}
              ...
              {({ values, isValid, setFieldValue }) => (
                <Form>
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={values.dateOfBirthBusinessGroupMember}
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={values.issueDateBusinessGroupMember}
                        setFieldValue={setFieldValue}
                        minDate={
                          new Date(values.dateOfBirthBusinessGroupMember)
                        }
                        disabled={values.dateOfBirthBusinessGroupMember === ''}
                      />
                    </div>
                  </div>
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={values.expiryDateBusinessGroupMember}
                        setFieldValue={setFieldValue}
                        minDate={minDateWithDate(
                          1,
                          values.issueDateBusinessGroupMember
                        )}
                      />
                    </div>
                  </div>
                          ...
                          businessGroupsData?.members?.map(member => (
                            <tr key={member._id}>
                              ...
                              <td className={`p-4 flex space-x-5 items-center`}>
                                <Link
                                  href={`/lk/slvisa/business-purpose-eta/apply-in-group/step-two/${member?._id}`}
                                >
                                  <CiEdit size={24} />
                                </Link>
                  ...
                  <div className="flex items-center justify-center my-5">
                    {businessGroupsData?.members?.length > 0 ? (
                      <Link
                        href={`/lk/slvisa/business-purpose-eta/apply-in-group/review/${businessGroupsData?._id}`}
