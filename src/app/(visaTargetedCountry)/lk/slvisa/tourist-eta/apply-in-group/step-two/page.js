...
const Page = () => {
  ...
  if (getQuery.error) {
    return router.push('/lk/slvisa/tourist-eta/apply-in-group');
  }
    ...
    return (
      <div>
        ...
        <div className="container md:py-8 py-20 md;px-0 px-3">
          ...
          <div>
            <Formik
              initialValues={touristGroupsSchema.initialValuesMember}
              ...
              {({ values, isValid, setFieldValue }) => (
                <Form>
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={values.dateOfBirthGroupTourist}
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={values.issueDateGroupTourist}
                        setFieldValue={setFieldValue}
                  ...
                  <div className="main-form-section">
                    ...
                    <div className="order-2 col-span-8">
                      <ReactDatePickerInput
                        ...
                        selected={values.expiryDateGroupTourist}
                        setFieldValue={setFieldValue}
                          ...
                          {touristGroupsData?.members?.length > 0 ? (
                            touristGroupsData?.members?.map(member => (
                              <tr key={member._id}>
                                ...
                                >
                                  <Link
                                    href={`/lk/slvisa/tourist-eta/apply-in-group/step-two/${member?._id}`}
                                  >
                                    <CiEdit size={24} />
                                  </Link>
                  ...
                  <div className="flex items-center justify-center my-5">
                    {touristGroupsData?.members?.length > 0 ? (
                      <Link
                        href={`/lk/slvisa/tourist-eta/apply-in-group/review/${touristGroupsData?._id}`}
