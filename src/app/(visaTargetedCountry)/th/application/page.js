          ...
          >
            {({ values, isValid, setFieldValue }) => (
              <Form>
                ...
                <hr className="w-full h-[0.15rem]  mt-4 bg-secondary" />
                ...
                <div className="py-8 text-center">
                  ...
                  <button
                    className={`cursor-pointer w-fit items-center gap-3 border-2 r font-semibold bg-secondary text-white px-12 py-3 rounded-full ${
