    ...
    return (
        <div>
            ...
            {morroccoMDData?.blogs.length > 0 ? (
                <BlogSlider
                    blogs={JSON.stringify(morroccoMDData?.blogs) ?? []}
                />
            ) : null}
        </div>
    );
...
export const metadata = {
    ...
    description:
        "Get guaranteed approval on your India visa with Visa Collect, apply for Morrocco visa online and experience a quick, secure, and hassle-free application process.",
