  ...
  return (
    <div>
      <div className="container  md:py-8 py-20 md;px-0 px-3 ">
        ...
        <div>
          <Formik
            initialValues={egyptSchema.initialValuesVisaDetails}
              ...
              <Form>
                ...
                <div className="main-form-section">
                  ...
                  <div className="mark-section group">
                    ...
                    <div className="tooltip-content">
                      ...
                      - You can enter Egypt after the arrival date if the visa still valid.
                      - You can not enter Egypt before the arrival date.
                    </div>
                  </div>
                ...
                <div className="main-form-section">
                  ...
                  <div className="mark-section group">
                    <BsQuestionCircleFill className=" side-icon" size={20} />
                    <div className="tooltip-content">
                      You can leave sooner or by the exit date. The exit date is the last day you are permitted to be in Egypt.
                    </div>
                  </div>
                ...
                <div className="main-form-section">
                  ...
                  <div className="order-2 col-span-8">
                    <textarea id="orderDetails.specialRequest" name="orderDetails.specialRequest" rows="4" className='w-full border border-gray-400'>
                    </textarea>
