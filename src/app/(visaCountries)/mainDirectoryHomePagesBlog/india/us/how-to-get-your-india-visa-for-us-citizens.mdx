...
To <LinkText text="Apply" href="/in"/> for an Indian tourist visa, US citizens must complete the online application form and submit it along with the required documents, including a copy of the passport's biographical page, a passport-sized photograph, and proof of return travel. The application fee can be paid online using a credit or debit card. The processing time for the e-visa application is up to 72 hours.
...
So, if you're excited to visit India, you can <LinkText text="apply for an Indian tourist visa online" href="/in"/> via <LinkText text="Visa Collect" href="/"/>.
