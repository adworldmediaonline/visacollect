...
const blogs = [
    {
        title: "Everything You Need to Know to Stress-Free Travel Planning for Any Trip",
        description:
    ...
    {
        title: "Top Best Free Game-Changing Social Media Tools and Strategies For Travel Agents",
        description:
            "Experience joy in the top cities of 2024! Discover the Happiest City Index for the best travel destinations. Happiness awaits in every corner.",
