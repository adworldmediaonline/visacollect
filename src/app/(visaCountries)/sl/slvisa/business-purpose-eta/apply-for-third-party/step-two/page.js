...
const Page = () => {
  ...
  if (getQuery.error) {
    return router.push('/sl/slvisa/business-purpose-eta/apply-for-third-party');
  }
        ...
        <div>
          ...
          <div className="container md:py-8 py-20 md;px-0 px-3">
            ...
            <div>
              <Formik
                initialValues={
                  businessThirdPartySchema.initialValuesMemberBusiness
                }
                validationSchema={
                ...
                {({ values, isValid, setFieldValue }) => (
                  <Form>
                    ...
                    <div className="main-form-section">
                      ...
                      <div className="order-2 col-span-8">
                        <ReactDatePickerInput
                          ...
                          selected={values.dateOfBirthThirdPartyBusiness}
                    ...
                    <div className="main-form-section">
                      ...
                      <div className="order-2 col-span-8">
                        <ReactDatePickerInput
                          ...
                          selected={values.issueDateThirdPartyBusiness}
                          setFieldValue={setFieldValue}
                          minDate={
                    ...
                    <div className="main-form-section">
                      ...
                      <div className="order-2 col-span-8">
                        <ReactDatePickerInput
                          ...
                          selected={values.expiryDateThirdPartyBusiness}
                          setFieldValue={setFieldValue}
                          ...
                          {businessThirdPartyData?.members?.length > 0 ? (
                            businessThirdPartyData?.members?.map(member => (
                              <tr key={member._id}>
                                ...
                                >
                                  <Link
                                    href={`/sl/slvisa/business-purpose-eta/apply-for-third-party/step-two/${member?._id}`}
                                  >
                                    <CiEdit size={24} />
                                  </Link>
                    ...
                    <div className="flex items-center justify-center my-5">
                      {businessThirdPartyData?.members?.length > 0 ? (
                        <Link
                          href={`/sl/slvisa/business-purpose-eta/apply-for-third-party/review/${businessThirdPartyData?._id}`}
