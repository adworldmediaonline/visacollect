...
import Ca from '../../subDirectoryHomePages/ca.mdx';
import FaqWithMDX from '@/components/commonWebsiteComponents/FaqWithMDX';
import { caFaq } from '@/app/faqMdx/caFaq/caFaq';
  ...
  return (
    <div>
      <Banner
        ...
        pageTitle="Canada to India: Apply for Your India tourist visa for canadian citizens"
        pageTitleDescription="Explore the land of wonders and uncover the unseen with VisaCollect."
      ...
      <div className="flex justify-center">
        <FaqWithMDX
          faqData={caFaq}
          titleText="Some FAQs for Travelers Traveling to India"
        />
      </div>
