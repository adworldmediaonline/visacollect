...
import ApplySection from '@/components/in/homepage/ApplySection';
import Banner from '@/components/in/homepage/Banner';
                              ...
                              <div className="formMain">
                                ...
                                {error ? (
                                  <div className="text-red-600">
                                    ...
                                    form{' '}
                                    <Link href="/in/visa/step-one">Create</Link>
                                  </div>
                                ) : null}
