...
import Uk from '../../subDirectoryHomePages/uk.mdx';
import FaqWithMDX from '@/components/commonWebsiteComponents/FaqWithMDX';
import { ukFaq } from '@/app/faqMdx/ukFaq/ukFaq';
  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <FaqWithMDX
          faqData={ukFaq}
          titleText="Indian Tourist e-Visa Application Frequently Asked Questions (FAQs)"
        />
      </div>
