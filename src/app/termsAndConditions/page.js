        ...
        <div>
            ...
            <div className="bg-white lg:pt-24 lg:py-10 lg:px-0 px-4 md:pt-28 md:pb-0 pt-28  pb-12 container">
                ...
                <div className=" mx-auto mt-7">
                    ...
                    <p className="text-base my-2 text-justify font-medium leading-relaxed" >
                        Please use our website and resources responsibly and in compliance with applicable laws and guidelines. Specifically:
                    </p>
                    <p className="text-base my-2 text-justify font-medium leading-relaxed" >
                        Provide accurate information about yourself.                </p>
                    <p className="text-base my-2 text-justify font-medium leading-relaxed" >
                ...
                <div className=" mx-auto mt-7">
                    ...
                    <p className="text-base my-2 text-justify font-medium leading-relaxed" >
                        Your privacy is important to us. Please refer to our privacy policy for more information.
                ...
                <div className=" mx-auto mt-7">
                    ...
                    <p className="text-base my-2 text-justify font-medium leading-relaxed" >
                        We may suspend or terminate your access to our website and resources, with or without notice, for any reason.
                    </p>
                </div>
