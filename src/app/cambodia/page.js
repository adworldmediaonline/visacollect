...
import { learnMoreSectionDataCambodia } from '@/constant/countryHomePageData/cambodia ';
  ...
  return (
    <div>
      <Banner
        ...
        pageTitle={learnMoreSectionDataCambodia?.pageTitle}
        pageName={learnMoreSectionDataCambodia?.pageName}
      />
      {/* <ProcessingStep
        ...
        <aside className="basis-[300px] py-5 md:py-12 space-y-4">
          <div className="container">
            ...
            <ul className="flex flex-col gap-3">
              {learnMoreSectionDataCambodia?.otherLinks?.map((link, index) => (
                <li key={index}>
      ...
      <Faq faqData={learnMoreSectionDataCambodia?.faqData} />
      {/* Remember: For the most accurate and up-to-date information, it's best to check the official website. */}
      <PageReview applyLink={learnMoreSectionDataCambodia?.applyNowLink} />
      <RelatedArticlesSlider
        relatedArticles={learnMoreSectionDataCambodia.relatedArticles}
      />
    </div>
  );
};
