      ...
      <div className="container px-4 pb-12 bg-white lg:pt-24 lg:py-10 lg:px-0 md:pt-28 md:pb-0 pt-28">
        <div className="mx-auto ">
          ...
          <p className="my-2 text-base font-medium leading-relaxed text-justify">
            Welcome to Visa Services! We&apos;re glad you&apos;re here. By using
            our website, you agree to follow our User Agreement and Privacy
        ...
        <div className="mx-auto mt-7">
          ...
          <p className="my-2 text-base font-medium leading-relaxed text-justify">
            All content and materials on Visa Services are protected by
        ...
        <div className="mx-auto mt-7">
          ...
          <p className="my-2 text-base font-medium leading-relaxed text-justify">
            By accessing our website, you agree to follow our country&apos;s
            laws. Any legal action related to this User Agreement will be
            brought to the courts in the same city as Visa Services Pvt
            Ltd&apos;s corporate office.
          </p>
        </div>
        ...
        <div className="mx-auto mt-7">
          ...
          <p className="my-2 text-base font-medium leading-relaxed text-justify">
            ...
            resources, with or without notice, for any reason.
          </p>
        </div>
        ...
        <div className="mx-auto mt-7">
          ...
          <p className="my-2 text-base font-medium leading-relaxed text-justify">
            ...
            please contact us at info@travel-indiaonline.com.
          </p>
        </div>
      </div>
    </div>
