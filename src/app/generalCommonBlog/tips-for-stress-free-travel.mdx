...
export const BlogContentHero = ({ src, className }) => (
  <div className={cn('mt-20  flex flex-col items-start justify-start', className)}>
    <img
...
<BlogContentHero src={stressFreeTravel} />
