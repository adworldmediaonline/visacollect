...
export const learnMoreSectionDataIndia = {
  ...
  sections: [
    {
      title:
        '<h2>Start your India Visa Apply Online Now process with our top-notch online visa services today!</h2>',
    },
    {
    ...
    },
    {
      ...
      lists: [
        {
          title:
            '<strong>Depending on your purpose of visit and nationality, you can choose from different eVisa types for India. Here are some of the most popular eVisa types:</strong>',
          listItems: [
  ...
  faqData: [
    ...
    },
    {
      ...
      des: `Only if you're coming from a yellow fever endemic country within six days of arrival. Please visit “https://visacollect.com” for more information.`,
      applyNow: (
    ...
    },
    {
      id: 10,
      title:
        'What are the advantages of applying for Indian visa online application? ',
    ...
    },
    {
      id: 13,
      title:
        'What are the different e-Visa categories and their validity periods?',
