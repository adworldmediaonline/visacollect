...
const learnMoreSectionDataAustralia = {
  ...
  sections: [
    ...
    },
    {
      ...
      lists: [
        {
          title: '1. Unleash Your Hidden Explorer:',
          listItems: [
    ...
    {
      title: 'Australia Visitor Visa: Financial requirements',
      paragraphs: [
        {
      ...
      lists: [
        ...
        {
          title: `Remember: The specific required documents may vary depending on your individual circumstances. Check the official immigration website for the latest updates.`,
        },
        {
    ...
    },
    {
      ...
      lists: [
        {
          title: 'Step 1: Kickstart Your Aussie Escape:',
          listItems: [
