          ...
          <Slider {...settings} ref={sliderRef}>
            {testimonials.map((testimonial, index) => (
              <div key={testimonial.id} className="px-4">
                ...
                >
                  <Card className="bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden group hover:border-primary/20">
                    {/* Glow effect */}
                    ...
                    <CardContent className="p-8 relative z-10">
                        ...
                        <div className="flex gap-1">
                          {[...Array(testimonial.rating)].map((_, i) => (
                            ...
                            />
                                              ...
                                              {/* Testimonial Text */}
                        <blockquote className="text-gray-600 text-base leading-relaxed text-center mb-8 font-medium">
                          "{testimonial.desc}"
                        </blockquote>
                      ...
                      <div className="flex items-center justify-center gap-4">
                        ...
                        <div className="text-center">
                          ...
                          <div className="inline-flex items-center gap-1 px-3 py-1 bg-primary text-white text-xs font-medium rounded-full mt-2 border-0">
        ...
        <div className="text-center mt-20">
          <div className="relative overflow-hidden bg-white border border-gray-200 rounded-3xl p-8 md:p-12 shadow-lg max-w-3xl mx-auto">
            ...
            <div className="space-y-8 relative z-10">
              ...
              <Button
                size="lg"
                className="group bg-primary hover:bg-primary/90 text-white font-semibold px-10 py-5 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl relative overflow-hidden text-lg"
              >
