      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="hidden lg:block absolute top-16 left-0 right-0 h-0.5 bg-white/10 mx-16">
            <div className="h-full bg-gradient-to-r from-primary to-primary-600" />
          </div>
            ...
            {processSteps.map((step, index) => (
              <div key={step.id} className="relative group">
                ...
                <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 z-30">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary-600 rounded-full flex items-center justify-center text-white font-bold text-xl shadow-2xl border-4 border-white/20 backdrop-blur-sm hover:scale-110 transition-transform duration-200">
                ...
                <Card className="relative h-full border-0 shadow-2xl hover:shadow-3xl hover:shadow-primary/20 transition-all duration-300 bg-white/5 backdrop-blur-lg border border-white/10 group-hover:bg-white/10 overflow-visible pt-12 mt-8">
                  ...
                  <CardContent className="p-8 text-center space-y-6 relative z-10">
                    ...
                    <div className="relative pt-4">
                      <div className="w-20 h-20 mx-auto bg-gradient-to-br from-primary/20 to-primary/30 rounded-2xl flex items-center justify-center relative overflow-hidden border border-white/20 hover:scale-105 transition-transform duration-200">
                    ...
                    <div className="pt-4">
                      <div className="flex justify-center">
                        <div className="w-16 h-1 bg-white/20 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-primary to-primary-600 rounded-full w-full" />
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="text-center mt-20">
          <div className="relative overflow-hidden bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl max-w-3xl mx-auto">
            ...
            <div className="space-y-8 relative z-10">
              ...
              <Button
                size="lg"
                className="group bg-gradient-to-r from-primary to-primary-600 hover:from-primary/90 hover:to-primary-700 text-white font-semibold px-10 py-5 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg"
              >
