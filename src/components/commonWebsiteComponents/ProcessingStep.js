      ...
      <div className="container">
        ...
        <Link href={link}>
          <div className="pt-10 flex justify-center items-center w-full">
            <button className="bg-secondary text-white transition duration-200 hover:bg-[#1e1e1e] hover:text-white px-12 rounded-full py-3 font-medium text-md md:block hidden">
              Apply For ETA Visa
            </button>
          </div>
        </Link>
