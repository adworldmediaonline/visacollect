    ...
    return (
        <div className="">
            <div
                ...
                style={{
                    backgroundImage: ' url("/assets/images/australia/footerimage.png")',
                }}
            >
                        ...
                        <div className="grid justify-start gap-6 pt-8 pb-12  md:grid-cols-12 md:px-0 md:pt-0">
                            <div className="col-span-5 space-y-4">
                                <Link href="/">
                                    <div>
                                        <Image
                                            src="/assets/images/australia/logo-white.png"
                                            width="140"
                                            height="140"
                                            alt="logo-white"
                                        />
                                ...
                                <div className="space-y-6">
                                    ...
                                    <ul className="">
                                        <Link href="/application">
                                            <li className="mt-2 text-base text-white hover:text-primary">
                                                <span className=""> Apply Visa Online</span>
                                            </li>
                                        </Link>
                                        <Link href="/application">
                                            <li className="mt-2 text-base text-white hover:text-primary">
                                                <span className="">Pay & Confirm</span>
                                            </li>
                                        </Link>
                                        <Link href="/application">
                                            <li className="mt-2 text-base text-white hover:text-primary">
                                                <span className="">Enter Turkey</span>
                                            </li>
                                        </Link>
