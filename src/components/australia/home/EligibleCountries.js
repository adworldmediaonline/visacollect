      ...
      <div className="container">
        ...
        <div className="pt-8 space-y-4">
          <h2 className="font-bold text-black">
            If your country is not listed above, you may have to obtain a
            standard visa - contact the nearest Australian embassy for more
            details.
          </h2>
          <p>
            If you hold a passport copy of one of the following nationalities{' '}
            <span className="text-primary font-bold text-lg">
              (USA, Canada, Malaysia, Japan, Hong Kong, Singapore, South Korea,
              Taiwan, Macau, Brunei)
            </span>{' '}
            you are eligible for eTA to Australia. There is no need to download
            any mobile app, as the whole process will be completed by us on your
            behalf. All you need to do is to submit an application on our
            website and upload the necessary documents - picture of yourself and
            a passport copy. We will take care of the whole process on your
            behalf in order to obtain an approved eTA for you.
          </p>
          <p>
            Alternatively, you can also book a consultation session with a
            Registered Migration Officer, who will guide you through the whole
            process.
          </p>

          <Link href="/application">
            <div className="pt-10 flex justify-left items-center w-full">
              <button className="bg-secondary text-white rounded-lg transition duration-200 hover:bg-[#1e1e1e] hover:text-white px-4 py-2 font-medium text-md md:block ">
                Apply For ETA Visa
              </button>
            </div>
          </Link>
