...
const ApplySectionUrgentHelp = () => {
  ...
  const cardData = [
    {
      id: 1,
      imgSrc: '/assets/images/in/common/paypal.png',
    },
    {
      id: 2,
      imgSrc: '/assets/images/in/common/mastercard-secured.png',
    },
    {
      id: 3,
      imgSrc: '/assets/images/in/common/varified.png',
    },
    {
      id: 4,
      imgSrc: '/assets/images/in/common/mastercard.png',
    },
  ];
  return (
    <>
